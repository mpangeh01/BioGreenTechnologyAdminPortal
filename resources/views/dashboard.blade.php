                            ...
                            <div class="h-100">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Good Morning, Gertrude!</h4>
                                                <p class="text-muted mb-0">Here's what's happening with your System
                                                    today.</p>
                                            </div>
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                                class="counter-value" data-target="183">0</span>
                                                        </h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                                class="counter-value" data-target="165">0</span>
                                                        </h4>
                                                ...
                                                <div class="row g-0 text-center">
                                                    <div class="col-6 col-sm-3">
                                                        <div class="p-3 border border-dashed border-start-0">
                                                            ...
                                                            <p class="text-muted mb-0">Febi</p>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-6 col-sm-3">
                                        ...
                                        <div class="card card-height-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="px-2 py-2 mt-1">
                                                    <p class="mb-1">Northern <span class="float-end">75%</span></p>
                                                    ...
                                                    <p class="mt-3 mb-1">Luapula <span class="float-end">47%</span>
                                                    </p>
                                                    <div class="progress mt-2" style="height: 6px;">
                                                        <div class="progress-bar progress-bar-striped bg-primary"
                                                    ...
                                                    <p class="mt-3 mb-1">Choongwe <span class="float-end">82%</span>
                                                    </p>
                                                    <div class="progress mt-2" style="height: 6px;">
                                                        <div class="progress-bar progress-bar-striped bg-primary"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card card-height-100">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Top Farmers</h4>
                                                <div class="flex-shrink-0">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    ...
                                                                                    class="text-reset">Martine
                                                                                    Fisheries</a>
                                                                            </h5>
                                                                            <span class="text-muted">Lwanga
                                                                                Francis</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="text-muted">Tilapia</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">8547</p>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">ZMW541200</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    href="apps-ecommerce-seller-details.html"
                                                                                    class="text-reset">Bio-Tech </a>
                                                                            </h5>
                                                                            <span class="text-muted">Mukonka
                                                                                Nkamu</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="text-muted">Cat Fish</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">895</p>
                                                                    <span class="text-muted">Stock</span>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">ZMW75030</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">ZMW45600</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                                    href="apps-ecommerce-seller-details.html"
                                                                                    class="text-reset">Yalelo
                                                                                    Fisheries</a></h5>
                                                                            <span class="text-muted">Joel Zimba</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="text-muted">Bream</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">5488</p>
                                                                    <span class="text-muted">Stock</span>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">ZMW29456</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <span class="text-muted">Jack
                                                                                Sparrow</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="text-muted">Bubble Fish</span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">4100</p>
                                                                    <span class="text-muted">Stock</span>
                                                                ...
                                                                <td>
                                                                    <span class="text-muted">ZMW11260</span>
                                                                </td>
                                                                <td>
