...
<head>
    ...
    <meta charset="utf-8" />
    <title>Users | Bio Tech - Admin</title>
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Martine Lwanga</span>
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Engineer</span>
                                    </span>
                                </span>
                            </button>
                    ...
                    <div id="scrollbar">
                        <div class="container-fluid">
                            ...
                            <ul class="navbar-nav" id="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="farmers.html">
                                        <i class="lar la-user-circle"></i> <span data-key="t-widgets">Farm Management</span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="ponds.html">
                                        <i class="lar la-user-circle"></i> <span data-key="t-widgets">Pond Management</span>
                                    </a>
                                </li>


                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="febi.html">
                                        <i class="lar la-user-circle"></i> <span data-key="t-widgets">Febi Management</span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="videos.html">
                                        <i class="lar la-user-circle"></i> <span data-key="t-widgets">Video Management</span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="users.html">
                                        <i class="lar la-user-circle"></i> <span data-key="t-widgets">User Management</span>
                                    </a>
                                </li>
        ...
        <div class="main-content">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Bio Technology</a></li>
                                            ...
                                            <table class="table align-middle" id="customerTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Users</th>
                                                        <th class="sort" data-sort="email">Email</th>
                                                        <th class="sort" data-sort="phone">Phone</th>
                                                        <th class="sort" data-sort="date">Creation Date</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="customer_name">Joel Zimba</td>
                                                        <td class="email">joel@biotech.co.zm</td>
                                                        <td class="phone">+2609626783326</td>
                                                        <td class="date">06 Feb, 2024</td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form class="tablelist-form" autocomplete="off">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="email-field" class="form-label">Farm Email</label>
                                                            <input type="email" id="email-field" class="form-control" placeholder="Enter email" required />
                                                            <div class="invalid-feedback">Please enter a Farm email.</div>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="phone-field" class="form-label">Farm Phone</label>
                                                            <input type="text" id="phone-field" class="form-control" placeholder="Enter phone no." required />
                                                            <div class="invalid-feedback">Please enter a Farm phone.</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <label for="status-field" class="form-label">Farm Status</label>
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="submit" class="btn btn-success" id="add-btn">Add Farm</button>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Bio-Green Technologies.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by Martine
                            </div>
                        </div>
                    </div>
                </div>
